...
1. **Pregunta antes de calcular** si falta información:
   ...
   - **Salario mensual del empleado** (si no se indica, usar SMLV $1.750.000)
...
4. **Reglas obligatorias:**
   ...
   - Jornada semanal máxima: 44 horas efectivas
...
5. **Tarifas (derivar del salario):**
   ...
   Hora ordinaria      = Salario mensual ÷ 220
   ...
   Dominical/festiva   = Ordinaria × 1,75

   Extra dominical     = Ordinaria × 2,00
...
El usuario puede escribir de forma coloquial. Interpretar:
...
| `gana el minimo` | $1.750.000 |
| `2.8 millones` | $2.800.000 |
| `turno noche 6pm-2am` | 18:00–02:00, cruce medianoche |

Si faltan datos (horarios, descansos, salario, fechas con festivos), **preguntar antes de calcular**.

Si el mensaje incluye **varios empleados**, liquidar cada uno por separado.
